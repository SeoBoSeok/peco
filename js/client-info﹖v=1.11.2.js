app.service('ClientInfo', ['$http', '$window', 'CutListCfg', '$injector',
    function($http, $window, CutListCfg, $injector) {

    var self = this;

    const euCountries = [
        'AT', 'BE', 'BG', 'CY', 'CZ', 'DE', 'DK', 'EE', 'EL', 'ES', 'FI', 'FR', 'HR', 'HU',
        'IE', 'IT', 'LT', 'LU','LV', 'MT', 'NL', 'PL', 'PT', 'RO', 'SE', 'SI', 'SK', 'XI', 'KO'
    ];
    ...
    try {
        ...
        self.version = '1.11.2';
        self.buildTimestamp = '2021-12-12 21:19';
        ...
        if (!self.ip || !self.location || !self.countryIsoCode) {
            // $http({
            //     method: 'GET',
            ...
            // }, function (error) {
            //     console.error("Error while getting client localization details\n" + e.stack);
            // }).finally(function () {
            //     fetchClientId();
            // });
        } else {
